...
public class PalabraCorrectaCarniceriaActivity extends AppCompatActivity {

    String[] answers={"Oilaskoa","Oilazkoa","Mihia","oiloa"};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_palabra_correcta_carniceria);
